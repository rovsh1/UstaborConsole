...
abstract class Element{
	...
	protected function getJsPlugin($options = array()) {
		if ($this->jsPlugin) {
			...
			return '<script type="text/javascript">$(document).ready(function(){ Form.initElement("' . $this->id . '","' . (true === $this->jsPlugin ? $this->type : $this->jsPlugin) . '",' . json_encode($options) . '); });</script>';
		}
		return '';
	}
