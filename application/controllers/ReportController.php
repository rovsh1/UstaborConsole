...
class ReportController extends InitController
{
    ...
    public function master_contacts_balanceAction()
    {
        ...
        $this->reportFormSubmit($form, 'master-contacts-balance');
    ...
    public function master_contacts_uniqueAction()
    {
        ...
        ;
        $this->reportFormSubmit($form, 'master-contacts-unique');
    ...
    public function master_without_projectsAction()
    {
        ...
        $form
            ...
            //->addElement('category_id')
        ;
        $this->reportFormSubmit($form, 'master-without-projects');
    ...
    public function master_statisticsAction()
    {
        ...
        $this->reportFormSubmit($form, 'master-statistics');
    ...
    public function customer_statisticsAction()
    {
        $form = new ReportForm();
        $form;
        $this->reportFormSubmit($form, 'customer-statistics');
    ...
    public function more_than_10_clicks_customersAction()
    {
        //$api = new PortalApi();
        $form = new ReportForm();
        $form
    ...
    public function request_4Action()
    {
        ...
        $form
            ...
            ->addElement('site_id')
            ->addElement('country_id');
        $this->reportFormSubmit($form, 'request-4');
    ...
    public function request_5Action()
    {
        ...
        $form
            ...
            ->addElement('country_id')
            ->addElement('category_id');
        $this->reportFormSubmit($form, 'request-5');
    ...
    public function request_6Action()
    {
        ...
        $form
            ...
            ->addElement(
                'type',
                'select',
                ['label' => 'Тип отчета', 'items' => ['customer' => 'Заказчики', 'master' => 'Мастера']]
            );
        $this->reportFormSubmit($form, 'request-6');
    ...
    public function request_7Action()
    {
        ...
        $form
            ...
            ->addElement('site_id')
            ->addElement('country_id');
        $this->reportFormSubmit($form, 'request-7');
    ...
    public function category_promotionsAction()
    {
        ...
        ;
        $this->reportFormSubmit($form, 'category-promotions');
    ...
    public function category_mastersAction()
    {
        ...
        $form
            ...
            ->addElement('site_id')//->addElement('country_id')
        ;
        $this->reportFormSubmit($form, 'category-masters');
    ...
    public function category_requestsAction()
    {
        ...
        ;
        $this->reportFormSubmit($form, 'category-requests');
    ...
    public function category_marketingAction()
    {
        ...
        ;
        $this->reportFormSubmit($form, 'category-marketing');
    ...
    public function request_8Action()
    {
        ...
        $form
            ...
            ->addElement('site_id')
            ->addElement('country_id');
        $this->reportFormSubmit($form, 'request-8');
    ...
    public function request_9Action()
    {
        ...
        $form
            ...
            ->addElement('site_id')
            ->addElement('country_id');
        $this->reportFormSubmit($form, 'request-9');
